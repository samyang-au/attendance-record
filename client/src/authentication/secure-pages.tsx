...
import { ROUTE_LOGIN, ROUTE_MAIN, ROUTE_MAINTAIN_MEMBERS, ROUTE_SERVICE_RECORD, ROUTE_UPDATE_PASSWORD } from 'global/const'
import { UpdatePassword } from './update-password'
import { useReactiveVar } from '@apollo/client'
import { AuthHeader } from './auth-header'
import { SideMenu } from 'menu/side-menu'
import { MaintainMembers } from 'member/maintain-members'
import { ServiceRecord } from 'service-record/service-record'
    ...
    return (
        <div className="secure-pages">
            ...
            <Switch>
                ...
                <Route path={`${ROUTE_SERVICE_RECORD}/:key`}>
                    <ServiceRecord />
                </Route>
                <Route path="/">
